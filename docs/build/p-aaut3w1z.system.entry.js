System.register(['./p-68dc9373.js'], function (exports, module) {
    ...
    return {
        ...
        execute: function () {
            ...
            var FORCED = isForced_1('RegExp', descriptors && (!CORRECT_NEW || fails(function () {
                re2[MATCH$1] = false;
            ...
            var f$3 = descriptors ? nativeGetOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
                O = toIndexedObject(O);
                P = toPrimitive(P, true);
                if (ie8DomDefine)
                    try {
            ...
            */
            ...
            var f$5 = _descriptors ? Object.defineProperty : function defineProperty(O, P, Attributes) {
                _anObject(O);
            ...
            var _toAbsoluteIndex = function (index, length) {
                ...
                return index < 0 ? max$2(index + length, 0) : min$5(index, length);
            };
            // false -> Array#indexOf
            // true  -> Array#includes
